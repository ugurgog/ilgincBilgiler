...
public class Earth {
    ...
    String[] EARTH_INFO = new String[]{
            ...
            "Hindistan’da damat gelinin kıyafetinden sorumlu oluyor.\n" +
                    "\n" +
                    "Gelin, beyaz gelinlik yerine, \"sari\" denilen özel bir giysi giyiyor. Törene gündelik kıyafetlerle gelen gelin, daha sonra kocasının kendisine sunduğu kıyafeti giyiyor.",
            ...
            "Shiva’ya tapan gizli Hint örgütü üyeleri Shiva’yı en üstün tanrı olarak görüyorlar. Shiva’nın her şeyi yarattığına inandıkları için hiçbir şeyin kötü olduğuna inanmıyorlar.\n" +
                    "\n" +
                    "Bu yüzden her türlü cinsel aktiviteye katılıyor, uyuşturucu kullanıp alkol tüketiyorlar ve et yiyorlar. Tabu anlayışları yok. Garip olan gelenekleri yamyam olmaları ve bunun için özel tapınakları var.\n" +
                    "\n" +
                    "Kıyafetlerini ölülerden temin ediyor, ölüyü yakıp ısınıyor ve yemeğini nehirden temin ediyorlar. Nehir üstünde sürüklenen kadavralar yakalanıyor ve uzuvlar kesildikten sonra çiğ olarak yeniyor.",
            ...
            "Bulgaristan’da da erkek, sevdiği kızı ailesinden istemek için en yakın arkadaşıyla kızın evine giderken, yanında mutluluk, sağlık ve zenginliği temsil eden \"rakia\" denilen özel bir ev viskisi ve \"zdravet\" adı verilen yeşil çiçeklerden küçük bir buket götürüyor.\n" +
                    ...
                    "\n" +
                    "Düğünden önceki Perşembe günü hamur ve mayanın karıştırılmasıyla özel bir ekmek yapılıyor ve bu ekmek yeni ailenin oluşumunu sembolize ediyor.\n" +
                    "\n" +
                    "Düğünde ise gelin, içinde bozuk para, çiğ yumurta ve buğday bulunan bir tabağı arkasına bakmadan başının üzerinden geriye doğru atıyor. Tabak ne kadar küçük parçalara ayrılırsa o kadar iyi olacağı düşünülüyor.\n" +
                    "\n" +
            ...
            "Çin’de de damadın ailesi astroloji uzmanına başvurarak evlenmeyi düşünen çift hakkında yorum istiyor.\n" +
                    "\n" +
                    "Eğer astroloji uzmanının hazırladığı horoskopu damadın ailesi uygun bulursa, çocuklarının doğum saatini ve tarihini kızın ailesine göndererek aynı işlemi onların da yapmasını istiyor. Çin’deki evlilik geleneklerine göre, düğünden önce damat evlilik yatağını hazırlayarak üzerine çeşitli meyve ve kuruyemişlerden koyuyor.\n" +
                    "\n" +
                    "Ailenin küçük çocukları yatağın üzerine oturtuluyor ve meyvelerle oynamalarına izin veriliyor. Yatağın üzerinde ne kadar çok çocuk olursa o kadar çok doğurganlığı sembolize edeceğine inanılıyor.\n" +
                    "\n" +
                    "Nedimelik yapacak bayanlar ise gelinin horoskopuyla uyumlu doğum yılına sahip kişilerden seçiliyor.\n" +
                    "\n" +
            ...
            "Tibet'te misafir uğurlanırken ona dil çıkarmak şart",
            ...
            "Moritanya'da uygulanan gelenek ise güzellik anlayışıyla ilgilidir. Bu adete göre ise evlenmek isteyen genç kızların kilosunun 60-100 arasında olması gerekir. Evlenmek isteyen genç kızın kilosu uymuyorsa kilo alıp o şekilde evlenmesi istenir. ",
            "Antik Mısır, cinselliğin en rahat ifade edilebildiği toplumlar arasındaydı. Bunu hem o zaman ortaya çıkan sanat eserlerinden hem de cinsel geleneklerinden anlayabiliriz. Antik Mısır’da Nil nehrinin gelgit etkisiyle taşması, bolluk tanrılarının orgazm olması ve boşalması anlamına geliyordu. Bir başka tuhaf inanış ise firavunlarla ilgili. O dönem tanrılarla eş görülen firavunlar tarım için suyun verimliliği artsın diye Nil Nehri’ne karşı mastürbasyon ayinleri düzenleniyordu.",
            "Endonezya’da Pon adı verilen bir kutlama var. Bu kutlama yılda yedi kez yapılıyor ve katılımcılar Java adasında kutsal bir dağa yolculuk ediyorlar. Burada insanlar seks yoluyla inançlarına göre şans ve bolluk diliyorlar. Yedi kez aynı kişiyle cinsel birliktelik yaşayan kişilerin dileklerinin kabul olacağına inanılıyor.",
            "Himalaya toprakları maalesef tarıma ve otlakçılığa çok uygun değil. Yani burada çok fazla tarım arazisi yok. Dolayısıyla aileler, erkek çocukları arasında bu toprakları bölüştürdüğünde her aileye çok az bir alan kalıyor. Bu sorunu da kadınların çok eşliliğiyle çözmüşler. Bir kadın, ailenin tüm erkek kardeşleriyle aynı anda evleniyor. Böylece tek aile olarak toprak bölüştürmek zorunda kalmıyorlar.",
            "Colombia halkının Guajiro adında, tören niteliğinde yaptıkları bir dans var. Bu törende kadınlar ve erkekler birlikte dans ediyorlar. Bu dans esnasında eğer kadın dansçı erkek dansçıya çelme takarsa cinsel birleşme şarttır.",
            "Tazmanya geleneklerine göre yeni evli çift, gerdeğe ilk düğün törenlerinde girerler ve bu, düğün davetlilerinin gözleri önünde gerçekleşir. Bize çok garip gelen bu gelenek, Tazmanya halkı için oldukça sıradan! Bu garip geleneğin bir benzeri Colombia‘da da var. Fakat Colombia’da sadece yeni gelinin annesi çiftin gerdek gecelerine şahitlik ediyor."
    };
